...
$.extend($.fn, {
                    ...
                    */
                    var newTab = $('<li class="jericho_tabs tab_selected" style="width:0px"  id="jerichotab_' + curIndex + '" dataType="' + ps.data.dataType + '" dataLink="' + ps.data.dataLink + '">' +
                                                    '<div class="tab_left"  style="width:' + (opts.tabWidth) + 'px"  >' +
                                                        ...
                                                        '<div class="tab_close">' + (ps.closeable ? '<span href="javascript:void(0)" title="Close" class="glyphicon glyphicon-remove"></span>' : '') + '</div>' +
                                                    '</div>' +
                                                '</li>')
    ...
    applyCloseEvent: function() {
        return this.each(function() {
            var me = this;
            $('.tab_close>span[title="Close"]', this).mouseup(function(e) {
