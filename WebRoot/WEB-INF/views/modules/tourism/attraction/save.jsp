...
<body>
	<div class="contents">
		<ul class="nav-tabs nav">
			<li>
				<a href="<%=basePath%>city/list">城市列表</a>
			</li>
			<li class="active">
				<a>${not empty city.id?'修改':'添加'}信息</a>
			</li>
		</ul>
		<div class="container saveform">
			<form:form action="${basePath }city/save" modelAttribute="city" class="form-horizontal">
				<form:hidden path="id"/>
				...
				<div class="form-group row">
					...
					<div class="col-8">
						<form:input path="name" class="form-control" placeholder="输入城市名称" maxlength="15" />
					</div>
				</div>
				<div class="form-group row">
